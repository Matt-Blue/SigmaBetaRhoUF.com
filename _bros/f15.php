...
<div class="row">
<img class="wide" id="width" src="_images/f15.jpg" alt="header">
</div>
...
<div class="row">
    <h2>TAU LINE</h2>
    <h3>FALL 2015</h3>
    <h3>PLEDGE MASTER: BROTHER ASSASSINATE</h3>
    <p>______________________________________________________________</p>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f151.jpg" alt="brother" id="profile">

                <br>
                #80 Mr. Quazi Caesar
                <br>
                Brother Green Hornet
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f152.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f153.jpg" alt="brother" id="profile">

                <br>
                #82 Mr. Matthew Bluestein
                <br>
                Brother Acelerador
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f154.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f155.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f156.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6 col-md-offset-3">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f157.jpg" alt="brother" id="profile">

                <br>
                #86 Mr. Matthew Villanueva
                <br>
                Brother Larghissimo
                <br>
                Field: Pharmacology
