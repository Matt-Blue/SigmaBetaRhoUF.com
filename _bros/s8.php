...
<div class="row">
<img class="wide" id="width" src="_images/s8.jpg" alt="header">
</div>
...
<div class="row">
    <h2>KAPPA LINE</h2>
    <h3>SPRING 2008</h3>
    <h3>PLEDGE MASTER: BROTHER SNAP! </h3>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s81.png" alt="brother" id="profile">

                <br>
                #34 Mr. Abraham Shaikh
                <br>
                Brother Warhawk
                <br>
                Field: Medicine
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s82.jpg" alt="brother" id="profile">
