...
<div class="row">
<img class="wide" id="width" src="_images/s12.jpg" alt="header">
</div>
...
<div class="row">
    <h2>XI LINE</h2>
    <h3>SPRING 2012</h3>
    <h3>PLEDGE MASTER: BROTHER ARSON </h3>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/s121.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/s122.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/s123.jpg" alt="brother" id="profile">

                <br>
                #58 Mr. Brandon Magtalas
                <br>
                Brother Stag
                <br>
                Field: Real Estate
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/s124.jpg" alt="brother" id="profile">
