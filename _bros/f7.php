...
<div class="row">
    <h2>IOTA LINE</h2>
    <h3>FALL 2007</h3>
    <h3>PLEDGE MASTER: BROTHER WILLOW </h3>
...
<div class="row">
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f71.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f72.png" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f73.png" alt="brother" id="profile">

                <br>
                #30 Mr. Mohammad Choudhary
                <br>
                Brother Dramatik
                <br>
                Field: Anthropology
...
<div class="row">
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f74.png" alt="brother" id="profile">

                <br>
                #31 Mr. Mohit Mathavan
                <br>
                Brother Balboa
                <br>
                Field: Chemistry
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f75.png" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f76.jpg" alt="brother" id="profile">

                <br>
                #33 Mr. David Saenz
                <br>
                Brother Bone Crusher
                <br>
                Field: Advertising
                <br>
                Classification: Alumni
