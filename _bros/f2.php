...
<div class="row">
    <h2>BETA LINE</h2>
    <h3>FALL 2002</h3>
    <h3>PLEDGE MASTER: FOUNDING FATHER PINATA </h3>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f21.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f22.png" alt="brother" id="profile">

                <br>
                #6 Mr. Shawnmeet Mukherjee
                <br>
                Brother Frodo
                <br>
                Field: Finance
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f23.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f24.jpg" alt="brother" id="profile">
