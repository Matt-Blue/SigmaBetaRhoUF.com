...
<div class="row">
<img class="wide" id="width" src="_images/f9.png" alt="header">
</div>
...
<div class="row">
    <h2>MU LINE</h2>
    <h3>FALL 2009</h3>
    <h3>PLEDGE MASTER: BROTHER HOTSHOT </h3>
...
<!-- THREE BROTHERS -->
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f91.png" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f92.png" alt="brother" id="profile">

                <br>
                #43 Mr. Thomas Aickara
                <br>
                Brother Scion
                <br>
                Field: Medicine
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f93.jpg" alt="brother" id="profile">
                ...
                Brother Slow Play
                <br>
                Field: Mathematics / Agricultural Sciences
                <br>
                Classification: Alumni
                <br>
            </p>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-4 col-md-offset-2">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f94.jpg" alt="brother" id="profile">

                <br>
                #45 Mr. Vikas Ramachandran
                <br>
                Brother Vulture
                <br>
                Field: Accounting
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f95.jpg" alt="brother" id="profile">

                <br>
                #46 Mr. Tejeswar Togatapola
                <br>
                Brother Arson
                <br>
                Field: Informations Technology
                <br>
                Classification: Alumni
                <br>
            </p>
