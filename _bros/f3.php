...
<div class="row">
    <h2>GAMMA LINE</h2>
    <h3>FALL 2003</h3>
    <h3>PLEDGE MASTER: FOUNDING FATHER WALDO </h3>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-5 col-md-offset-1">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f31.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-5">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f32.png" alt="brother" id="profile">
