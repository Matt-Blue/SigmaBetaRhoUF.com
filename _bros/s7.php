...
<div class="row">
<img class="wide" id="width" src="_images/s7.jpg" alt="header">
</div>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s71.png" alt="brother" id="profile">
                ...
                Brother Igneous
                <br>
                Fields: Engineering and Pharmacy
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s72.png" alt="brother" id="profile">
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s73.png" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s74.png" alt="brother" id="profile">
