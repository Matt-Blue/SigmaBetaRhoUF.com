...
<div class="row">
<img class="wide" id="width" src="_images/f12.jpg" alt="header">
</div>
...
<div class="row">
    <h2>OMICRON LINE</h2>
    <h3>FALL 2012</h3>
    <h3>PLEDGE MASTER: BROTHER SLOW PLAY </h3>
    <p>______________________________________________________________</p>
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/f121.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/f122.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/f123.jpg" alt="brother" id="profile">

                <br>
                #62 Mr. Navneet Venkatesh
                <br>
                Brother Barrage
                <br>
                Field: Finance
        ...
        <div class="col-md-6">
            <!-- FILL IN INFO -->
            <p id="centered">
                <img src="_images/f124.jpg" alt="brother" id="profile">

                <br>
                #63 Mr. Jaremy Karedan
                <br>
                Brother Blood Diamond
                <br>
