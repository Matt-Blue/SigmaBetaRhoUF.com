...
<div class="row">
    <h2>PHI LINE</h2>
    <h3>FALL 2017</h3>
    <h3>PLEDGE MASTER: BROTHER GREEN HORNET</h3>
    <p>______________________________________________________________</p>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f171.jpg" alt="brother" id="profile">

                <br>
                #90 Mr. Leverto Jean Charles
                <br>
                Brother G.L.α.C.I.E.R.
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/f172.jpg" alt="brother" id="profile">
