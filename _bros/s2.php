...
<!--TODO Title-->
<div class="row">
    <h2>FOUNDING FATHERS - ALPHA LINE</h2>
    <h3>SPRING 2002</h3>
    <h3>PLEDGE MASTER: BROTHER DARKIE </h3>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s21.jpg" alt="brother" id="profile">

                <br>
                #1 Mr. Akash Kuruvilla
                <br>
                Founding Father Pinata
                <br>
                Field: Law
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s22.png" alt="brother" id="profile">

                <br>
                #2 Mr. Aleem Kanji
                <br>
                Founding Father Blaze
                <br>
...
<!-- PAIR OF BROTHERS -->
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s23.png" alt="brother" id="profile">

                <br>
                #3 Kevin Patel
                <br>
                Founding Father P.L.O.P.
                <br>
        ...
        <div class="col-md-6">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s24.png" alt="brother" id="profile">

                <br>
                #4 Mr. Anurag Singh
                <br>
                Founding Father Waldo
                <br>
                Field: Medical
                <br>
                Classification: Alumni
