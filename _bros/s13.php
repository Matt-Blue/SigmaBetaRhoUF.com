...
<div class="row">
<img class="wide" id="width" src="_images/s13.jpg" alt="header">
</div>
...
<div class="row">
    <h2>PI LINE</h2>
    <h3>SPRING 2013</h3>
    <h3>PLEDGE MASTER: BROTHER SOPRANO</h3>
    <p>______________________________________________________________</p>
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s131.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s132.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-4">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s133.jpg" alt="brother" id="profile">
        ...
        <div class="col-md-12">
            <!-- TODO FILL IN INFO -->
            <p id="centered">
                <img src="_images/s134.jpg" alt="brother" id="profile">

                <br>
                #67 Mr. Ahmed Adediran
                <br>
                Brother Punchline
                <br>
                Field: APK
